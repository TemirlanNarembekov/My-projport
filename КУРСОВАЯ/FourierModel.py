...
# Отбираем только значимые переменные (p-value < 0.01)
# significant_predictors = [var for var in initial_model.pvalues[initial_model.pvalues < 0.01].index if var in X.columns]

# # Создаем новый набор данных только с константой и значимыми предикторами


# X_significant = sm.add_constant(X[significant_predictors])
...
print(f"Статистика теста Бреуша-Годфри: {bg_test[0]}")
print(f"P-значение теста: {bg_test[1]}")

print(1.8013798830419523e-06 < 0.01)